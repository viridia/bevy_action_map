...
Fenced code blocks, table rows (`|...`), headings (`#...`), and reference-style link definitions
(`[label]: target`) are never reflowed. A markdown list item (`- `, `* `, `+ `, `1. `) reflows with
its continuation lines hung under the marker.
