# Work log, archive: chunks 1–36

> The first six phases, closed. [Log.md](./Log.md) carries Phase VII onward and is the one to read;
> this is here so that it does not have to carry these as well.
>
